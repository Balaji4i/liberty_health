CREATE OR REPLACE PROCEDURE cpr_update_receipt_no2_prc                            
IS

--This procedure is only to balance comms_payments_received with comms_calc_snapshot 
--  where the finance_receipt_no on the tables is THOLOENERGY_20180406 and 
--  the finance_invoice_no on comms_payments_received is not 1121 
...
begin
   ...
   FOR rec IN cpr_fk loop 
    ...
    COMMIT;
end cpr_update_receipt_no2_prc;                         