create or replace procedure CPR_UPDATE_GROUPING_JHPGL_PRC(
    p_input_month_from IN varchar2, 
    p_input_month_to IN VARCHAR2)                            
is

-- This code works for 
-- April 2017, May 2017, Jun 2017, Jul 2017, Aug 2017, Sept 2017, 
-- Jan 2018, Febr 2018, March 2018, April 2018, May 2018 
-- and also for Oct 2017, November 2017, December 2017  
-- when using the group JHPIEGOLESO and 
-- the rows where finance_receipt_no is 'JHPIEGOLESO_21022018' or 'JHPIEGOLESO_22022018' are excluded 
              ...
              FROM 
                ...
                FROM lhhcom.temp_backup_ls1061b
                   WHERE processed_ind = 'Y' 
                     ...
                     AND FINANCE_RECEIPT_NO not in ('JHPIEGOLESO_21022018', 'JHPIEGOLESO_22022018')                     
                     ) cpr_aggr_val            
                GROUP BY   
                  cpr_aggr_val.contribution_date
                , cpr_aggr_val.country_code
...
begin
   ...
   FOR rec IN cpr_fk loop 
    ...
    COMMIT;
end cpr_update_grouping_jhpgl_prc;                