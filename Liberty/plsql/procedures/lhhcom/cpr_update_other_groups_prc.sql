CREATE OR REPLACE PROCEDURE cpr_update_other_groups_prc(
...
-- when excluding the group JHPIEGOLESO
-- Also excluded finance_invoice_no 'RIGHTOCARE_20180430', 'SASOLBASE_20180409', 'THOLOENERGY_20180406'
-- Included finance_invoice_no 'JHPIEGOLESO_21022018', 'JHPIEGOLESO_22022018' although it is from group JHPIEGOLESO
...
begin
   ...
   FOR rec IN cpr_fk loop
    ...
    COMMIT;
end cpr_update_other_groups_prc;               