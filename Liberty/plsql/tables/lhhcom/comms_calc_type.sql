  ...
  CREATE TABLE "LHHCOM"."COMMS_CALC_TYPE" 
   (	"COMMS_CALC_TYPE_CODE" CHAR(1 CHAR) NOT NULL ENABLE, 
	"COMMS_CALC_TYPE_DESC" VARCHAR2(50 CHAR) NOT NULL ENABLE, 
	...
	"USERNAME" VARCHAR2(50 CHAR) NOT NULL ENABLE, 
	 CONSTRAINT "COMMS_CALC_TYPE_PK" PRIMARY KEY ("COMMS_CALC_TYPE_CODE")
