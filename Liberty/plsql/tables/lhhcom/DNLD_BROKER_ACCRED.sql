CREATE TABLE "LHHCOM"."DNLD_BROKER_ACCRED" 
   ("BROKER_ID_NO" NUMBER(9,0) NOT NULL ENABLE, 
	...
	"USERNAME" VARCHAR2(50 CHAR) NOT NULL ENABLE, 
	 CONSTRAINT "DNLD_BROKER_ACCRED" PRIMARY KEY ("BROKER_ID_NO","EFFECTIVE_START_DATE","ACCREDITATION_TYPE_ID_NO", "STAMP_DATETIME")
