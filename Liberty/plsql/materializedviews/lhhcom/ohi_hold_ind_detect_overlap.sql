-- DROP MATERIALIZED VIEW LOG ON "LHHCOM"."OHI_HOLD_IND";
-- DROP MATERIALIZED VIEW "LHHCOM"."OHI_HOLD_IND_DETECT_OVERLAP";

CREATE MATERIALIZED VIEW LOG ON "LHHCOM"."OHI_HOLD_IND" 
  WITH ROWID (
       product_code
      ,poep_id
      ,inse_code
...
/
CREATE MATERIALIZED VIEW "LHHCOM"."OHI_HOLD_IND_DETECT_OVERLAP"
  BUILD IMMEDIATE 
  REFRESH FORCE
  ON COMMIT
  AS
    SELECT 
      ...
      FROM ohi_hold_ind ocp
      JOIN ohi_hold_ind ocpa 
        ON
          (
     ...
     GROUP BY
          ...
          ,ocp.effective_end_date;
/
ALTER TABLE "LHHCOM"."OHI_HOLD_IND_DETECT_OVERLAP"
  ADD
    CONSTRAINT OHI_HOLD_IND_NO_DATE_OVERLAPS CHECK(num_overlaps = 0);
/