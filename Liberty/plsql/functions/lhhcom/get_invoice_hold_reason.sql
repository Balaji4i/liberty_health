-- Helen Lane 27/06/2018 LS-1301 ensure that resigned brokerages get paid if they have a payment due. 
...
cursor c_get_company_status is
  -- Helen - LS-1301 ensure that resinged brokerages (27) as well as active brokerages (25) get paid, ie get 'Y'.
  select decode(cf.company_table_type_id_no,25,'Y',27,'Y','N') ind, company_table_type_desc
