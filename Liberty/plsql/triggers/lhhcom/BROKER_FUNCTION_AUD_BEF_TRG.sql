CREATE OR REPLACE EDITIONABLE TRIGGER "LHHCOM"."BROKER_FUNCTION_AUD_BEF_TRG"
...
BEFORE INSERT OR UPDATE OR DELETE ON BROKER_FUNCTION
...
DECLARE
  ...
  aud BROKER_FUNCTION_AUDIT%ROWTYPE;
...
-- In Case we don't want to allow deleting
  ...
  IF l_write_aud = 'Y' THEN
    INSERT INTO BROKER_FUNCTION_AUDIT VALUES aud;
  END IF;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      ...
      RAISE;
END BROKER_FUNCTION_AUD_BEF_TRG;
/
