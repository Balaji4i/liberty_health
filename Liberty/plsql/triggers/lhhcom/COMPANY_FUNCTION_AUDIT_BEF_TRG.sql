CREATE OR REPLACE EDITIONABLE TRIGGER "LHHCOM"."COMPANY_FUNCTION_AUDIT_BEF_TRG"
...
BEFORE INSERT OR UPDATE OR DELETE ON COMPANY_FUNCTION
...
DECLARE
  ...
  aud COMPANY_FUNCTION_AUDIT%ROWTYPE;
...
-- In Case we don't want to allow deleting
  ...
  IF l_write_aud = 'Y' THEN
    INSERT INTO COMPANY_FUNCTION_AUDIT VALUES aud;
  END IF;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      ...
      RAISE;
END COMPANY_FUNCTION_AUDIT_BEF_TRG;
/
