...
';
          IF p_debug = 'Y' THEN
            ...
            "INSERT INTO globaltemp_json_workspace" Success!!
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
          END IF;
  ...
  IF p_debug = 'Y' THEN
    dbms_output.put_line('
    Now writing records to globaltemp_pay_comms . . .');
  END IF;
  BEGIN
  ...
  EXCEPTION
    WHEN OTHERS THEN
      dbms_output.put_line('Unhandled Exception Error when Inserting GLOBALTEMP_PAY_COMMS records: ' || sqlerrm);
  END;
