/**
* ----------------------------------------------------------------------
* Change Request: LS-2240 - Additional Comms and Invoice load
*
* Description  : LS-2240 - Additional Comms and Invoice load
* Author       : Sarel Eybers
* Date         : 2018-11-05
...
define p_upd_ccs = TRUE;
define p_upd_inv_jnl = TRUE;
define p_upd_inv_his = TRUE;
...
--                      OR  cm_dt_pay = 0)
           WHERE     cm_dt_run >= 20181008 
                 AND trim(com.ag_code) IN ('832000013', '10000094', '774000000')
