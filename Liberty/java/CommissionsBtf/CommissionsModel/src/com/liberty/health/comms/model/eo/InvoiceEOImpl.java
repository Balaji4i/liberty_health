...
public class InvoiceEOImpl extends EntityImpl {
     ...
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getInvoiceType() {
        return (RowIterator) getAttributeInternal(INVOICETYPE);
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.liberty.health.comms.model.eo.InvoiceEO");
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        SequenceImpl seq = new SequenceImpl("INVOICE_NO_SEQ", getDBTransaction());
